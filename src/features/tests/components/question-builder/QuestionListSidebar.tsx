        ...
        {questions.map((index) => {
          ...
          if (isCollapsed) {
            return (
              ...
              >
                {!isActive && isCompleted ? <Check className="size-4 text-emerald-600" /> : index + 1}
              </button>
            );
          }
          ...
          return (
            ...
            >
              <div className="flex min-w-0 items-center gap-2.5">
                ...
                >
                  {!isActive && isCompleted ? <Check className="size-3" /> : index + 1}
                </div>
              ...
              <ChevronRight
                className={cn(
                  ...
                  isActive ? 'text-[#7489FF]' : isCompleted ? 'text-emerald-500' : 'text-slate-300',
                )}
              />
            </button>
          );
